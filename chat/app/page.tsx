      ...
      <div className="flex-1 max-w-3xl mx-auto w-full px-6 pb-32">
        {messages.length === 0 ? (
          <div className="h-[70vh] flex flex-col items-center justify-center">
            <h1 className="text-4xl font-light mb-2">Nomos ARGS-POL</h1>
            <p className="text-gray-500">Ask about FEC 2025-26 contributions</p>
          </div>
        ) : (
          <div className="pt-8 space-y-6">
            ...
            {loading && (
              <div>
                <p className="text-sm font-bold uppercase tracking-wide mb-2" style={{ color: "var(--primary)" }}>Nomos</p>
